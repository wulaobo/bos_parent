...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="form" action="${ pageContext.request.contextPath }/userAction_add.action" method="post" >
           <table class="table-edit"  width="95%" align="center">
			   ...
			   <tr><td>角色:</td>
				   ...
				   <script type="text/javascript">
                       $(function () {
                           $.post("${ pageContext.request.contextPath }/RoleAction_findAllRole",function (data) {
                              // alert(data);
				   ...
				   <%--<td>--%>
					   <%--<input type="checkbox" id="test" value="123">--%>
					   <%--<label for="test">--%>
						   <%--测试--%>
					   <%--</label>--%>
				   <%--</td>--%>
