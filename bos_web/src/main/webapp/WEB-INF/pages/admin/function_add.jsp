					...
					<tr>
						...
						<td>
							<input name="parentFunction.id" class="easyui-combobox"
								   data-options="valueField:'id',textField:'name',url:'${ pageContext.request.contextPath }/FunctionAction_findAllFunction.action'"/>
								<%--<input class="easyui-combotree" name="parentFunction.id"--%>
									   <%--data-options="url:'${ pageContext.request.contextPath }/FunctionAction_findAllFunction.action'"--%>
									   <%--style="width:170px;">--%>
						</td>
					</tr>
					<tr>
