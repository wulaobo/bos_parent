		...
		<form id="noticebillForm" action="${ pageContext.request.contextPath }/NoticeBillAction_add.action" method="post">
			<table class="table-edit" width="95%" align="center">
				...
				<tr>
						...
						<script type="text/javascript">
							$(function () {
								$("input[name='telephone']").blur(function () {
									...
									//alert(telephone);
									$.post("${pageContext.request.contextPath}/NoticeBillAction_findCustomerByTelephone.action",{telephone:telephone},function (data) {
                                         if(data !=null) {
                                             var customerId = data.id;
                                             var customerName = data.name;
                                             var delegater = data.name;
					...
					<td>客户编号:</td>
					<td><input type="text" class="easyui-validatebox"  name="customer_id"
						 /></td>
				</tr>
				<tr>
					<td>客户姓名:</td>
					<td><input type="text" class="easyui-validatebox" name="customer_name"
						/></td>
					<td>联系人:</td>
