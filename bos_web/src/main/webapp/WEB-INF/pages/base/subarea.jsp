...
<script type="text/javascript">
	...
	function doExport(){
		//alert("导出");
		//get方式发出请求
		location.href="${pageContext.request.contextPath}/SubareaAction_download.action";
	}
	...
	function doshowHighCharts() {
        ...
        $.post("${ pageContext.request.contextPath }/SubareaAction_findSubareaByGroupProvince.action",function (data) {
            $('#test').highcharts({
                chart: {
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubareaForm" action="${pageContext.request.contextPath}/SubareaAction_save.action" method="post">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/RegionAction_findAll.action',mode:'remote'" />
						</td>
					</tr>
					<tr>
						<td>关键字</td>
	...
	<!-- 区域分区分布图 -->
	<div class="easyui-window" title="分区添加修改" id="showHighCharts" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
