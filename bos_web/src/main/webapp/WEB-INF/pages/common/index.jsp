...
<script type="text/javascript">
	// 初始化ztree菜单
		...
		$("#btnEp").click(function(){
			//alert("修改密码");
			var v = $("#validateForm").form("validate");
			if(v) {
			    //校验两次输入密码是否一致
                //alert(v);
					...
					$.post("${pageContext.request.contextPath}/userAction_editPassword",{password:v1},function (data) {
					      //判断密码是否修改成功
                           if(data=='1') {
                               //修改成功,关闭窗口
							   $("#editPwdWindow").window("close");
                               $.messager.confirm("提示信息", "修改密码成功,请重新登录", function (a) {
                                   //alert(a);
								   if(a){
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
				...
				<table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input  data-options="required:true,validType:'length[4,6]'" id="txtNewPass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input data-options="required:true,validType:'length[4,6]'" id="txtRePass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                </table>
				</form>
            </div>
